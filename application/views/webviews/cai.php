...
<div class="row">
	...
	<!-- first column end -->
<div class="col-md-7 ">
<form enctype="multipart/form-data" action="addCai" method="post">
  <div class="form-group">
    <label for="vname">新菜名</label>
    <input type="text" class="form-control" id="vname" placeholder="输入新菜名" name="vname">
  </div>
  <div class="form-group">
    <label for="price">价格</label>
    <input type="text" class="form-control" id="price" placeholder="输入价格" name="price">
  </div>
   <div class="form-group">
    <label for="descrition">描述</label>
    <input type="text" class="form-control" id="description" placeholder="输入描述" name="description">
  </div>
  <div class="form-group">
